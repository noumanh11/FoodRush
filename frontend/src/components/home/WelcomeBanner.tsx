      ...
      <div className="relative flex flex-col sm:flex-row sm:items-center gap-5">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1.5 max-w-lg">{roleInfo.subtitle}</p>
          </div>
        </div>

        <div className="sm:ml-auto flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-800/80 border border-slate-700/50 animate-slide-in-right stagger-3">
          <ChefHat size={18} className="text-brand-400" />
          <span className="text-sm text-slate-300 capitalize">{user.role} account</span>
        </div>
      </div>
    </div>
  );
